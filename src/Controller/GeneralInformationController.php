...
{
    /**
     * @Route("user/{id_user}/catalog/{id_catalog}/update/product/{id_product}/general_information", name="general_information", methods={"GET","POST"})
     * 
    ...
    {
        $form = $this->createForm(GeneralInformationFormType::class, $product);
        ...
        return $this->render('updateAddTemplates/generalInfo.html.twig', [
            'formGI' => $form->createView(),
            'product' => $product,
            'catalog' => $catalog,
            'user' => $user
        ]);
